...
static void NSDL_OuyaNotifyResolutionRestart( UViewport* Viewport, INT W, INT H )
{
	...
	if( W == 0 && H == 0 )
		appSprintf( Message, "OUYA render resolution set to 960x540. Restart Unreal to apply." );
	else
