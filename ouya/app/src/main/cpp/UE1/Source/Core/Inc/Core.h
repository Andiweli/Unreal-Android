// OUYA render hotfix:
// Keep Android/API16 legacy build active, but disable native OUYA-specific renderer/viewport
// branches for now. The first OUYA 960x540 path caused flickering garbage on Tegra3.
// We keep ANDROID_LEGACY_API16 active, but force native code back to the stable Android path.
#ifdef UNREAL_ANDROID_OUYA
#undef UNREAL_ANDROID_OUYA
#define UNREAL_ANDROID_OUYA_NATIVE_DISABLED 1
#endif
/*=============================================================================
