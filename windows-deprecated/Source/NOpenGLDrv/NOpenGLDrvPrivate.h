...
class DLL_EXPORT UNOpenGLRenderDevice : public URenderDevice
{
	...
	INT SwapInterval;
	UBOOL RuntimeLowDetailTextures; // UE1_WINDOWS_TEXTURE_DETAIL_V16_PRIVATE
	...
	void SetBlend( DWORD PolyFlags, UBOOL InverseOrder = false, UBOOL PreserveTranslucentMask = false );
	...
	void ConvertTextureMipI8( const FTextureInfo& Info, const FMipmap* Mip, const UBOOL Masked, BYTE*& UploadBuf, GLenum& UploadFormat, GLenum& InternalFormat );
	...
	void UpdateRuntimeLowDetailTextures();
