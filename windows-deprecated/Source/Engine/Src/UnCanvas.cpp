...
#include <string.h>
#endif
#if defined(PLATFORM_ANDROID) || defined(PLATFORM_WIN32) || defined(_WIN32) // UE1_ANDROID_AUDIOVIDEO_MENU_DRAW_FIX / UE1_WINDOWS_MENU_DRAW_FIX
...
#if defined(PLATFORM_ANDROID) || defined(PLATFORM_WIN32) || defined(_WIN32) // UE1_ANDROID_MULTIPLAYER_JOIN_MENU_DRAW_FIX / UE1_WINDOWS_MULTIPLAYER_MENU_DRAW_FIX
