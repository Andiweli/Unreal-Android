...
#if defined(PLATFORM_WIN32) || defined(_WIN32) // UE1_WINDOWS_LOWDETAIL_POSTEDIT_V17_BEGIN
	SaveConfig();
	if( Engine )
		Engine->Flush();
	debugf( NAME_Log, "Client: Windows LowDetailTextures=%s", LowDetailTextures ? "True" : "False" );
#endif // UE1_WINDOWS_LOWDETAIL_POSTEDIT_V17_END
