...
// UNREAL_ANDROID_INFINITE_AMMO_POST_TICK_V23
extern "C" void UE1AndroidRefreshInfiniteAmmoAfterLevelTickV23( ULevel* Level );
#endif
...
#if defined(PLATFORM_ANDROID) || defined(UNREAL_ANDROID) || defined(__ANDROID__)
	// Restore protected ammo after all gameplay/script ticks but before
	// networking and rendering can observe a consumed value.
	UE1AndroidRefreshInfiniteAmmoAfterLevelTickV23( this ); // UNREAL_ANDROID_INFINITE_AMMO_POST_TICK_V23
#endif
