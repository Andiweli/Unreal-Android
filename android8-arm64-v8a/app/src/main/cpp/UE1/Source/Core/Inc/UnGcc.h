...
typedef intptr_t  PTRINT; // Pointer-sized signed integer for address arithmetic.
typedef uintptr_t UPTRINT; // Pointer-sized unsigned integer for address arithmetic.
