...
// UE1_WINDOWS_GETRES_CURATED_1080P_V12_BEGIN
		
struct FUE1WinMenuRes { INT W; INT H; };
		
static const FUE1WinMenuRes PreferredRes[] =
...
for( INT i=0; i<ARRAY_COUNT(PreferredRes); ++i )
...
Result.Appendf( "%ix%i", PreferredRes[i].W, PreferredRes[i].H );
		
}
		
// UE1_WINDOWS_GETRES_CURATED_1080P_V12_END
#else
