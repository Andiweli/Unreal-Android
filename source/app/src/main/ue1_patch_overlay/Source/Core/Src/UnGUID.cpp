...
#include <stdlib.h>
#include <stdint.h> // UNREAL_ANDROID_GUID_FIXED_WIDTH_V8
#include <string.h>
#include <sys/types.h>
#include <sys/time.h>
#include <unistd.h>
...
// The historical code assumed unsigned long was 32 bit.  Android arm64 is
// LP64, where unsigned long is 64 bit; that made uuid_t 24 bytes and caused
// appGetGUID() to overwrite Unreal's 16-byte FGuid on every save.
typedef uint32_t        unsigned32; // UNREAL_ANDROID_GUID_FIXED_WIDTH_V8
...
static_assert(sizeof(uuid_t) == 16, "uuid_t must match Unreal FGuid size"); // UNREAL_ANDROID_GUID_SIZE_ASSERT_V8
