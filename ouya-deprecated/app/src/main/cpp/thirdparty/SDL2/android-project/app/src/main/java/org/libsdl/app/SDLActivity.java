...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 18) {
            ...
            android.util.Log.v(TAG, "OUYA/API16: SDL HIDAPI disabled, using normal SDL joystick/controller path");
    ...
    protected void onPause() {
        ...
        if (mHIDDeviceManager != null) {
            if (mHIDDeviceManager != null) { mHIDDeviceManager.setFrozen(true); }
        }
        if (!mHasMultiWindow) {
            pauseNativeThread();
        }
    ...
    protected void onResume() {
        ...
        if (mHIDDeviceManager != null) {
            if (mHIDDeviceManager != null) { mHIDDeviceManager.setFrozen(false); }
        }
        if (!mHasMultiWindow) {
            resumeNativeThread();
        }
